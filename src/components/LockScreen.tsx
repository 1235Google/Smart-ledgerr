    ...
    >
      <div className="flex flex-col items-center max-w-sm w-full bg-white/5 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl backdrop-blur-xl">
        ...
        <p className="text-slate-400 mb-8 text-sm text-center">
          {securitySettings.pinEnabled ? 'Enter your PIN to access your account' : 'No PIN configured. Use Google Login.'}
        </p>
        ...
        {!securitySettings.pinEnabled && (
          <button
            ...
            className="w-full bg-white text-black hover:bg-neutral-200 font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2 mt-4"
          >
